...
namespace gsim {
	// Constants
	const uint32_t GRAVITY_SHADER_SOURCE[] {
#include "Shaders/GravityShader.comp.u32"
	};
	const uint32_t VELOCITY_SHADER_SOURCE[] {
#include "Shaders/VelocityShader.comp.u32"
	...
	static void CreateDescriptorPool() {
		...
		VkWriteDescriptorSet descriptorWrites[POINT_BUFFER_COUNT];
		...
		vkUpdateDescriptorSets(GetVulkanDevice(), POINT_BUFFER_COUNT, descriptorWrites, 0, nullptr);
	}
